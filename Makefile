...
FILES := ./graphy/DES/des.c ./graphy/FEAL/feal.c ./graphy/GOST/gost.c ./graphy/IDEA/idea.c ./graphy/LOKI91/loki.c ./graphy/MMB/mmb.c ./graphy/stream/stream.c ./analysis/brute-force/brute_force.c ./graphy/MD5/md5.c ./graphy/SHA/sha.c ./graphy/N-Hash/nhash.c ./graphy/HAVAL/haval.c ./graphy/AES/aes.c
