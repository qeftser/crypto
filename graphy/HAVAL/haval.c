...
#define O$51(x6,x5,x4,x3,x2,x1,x0) x3,x4,x1,x0,x5,x2,x6
#define O$52(x6,x5,x4,x3,x2,x1,x0) x6,x2,x1,x0,x3,x4,x5
#define O$53(x6,x5,x4,x3,x2,x1,x0) x2,x6,x0,x4,x3,x1,x5
#define O$54(x6,x5,x4,x3,x2,x1,x0) x1,x5,x3,x2,x0,x4,x6
#define O$55(x6,x5,x4,x3,x2,x1,x0) x2,x5,x0,x6,x4,x3,x1

void H_HAVAL(uint32_t * Din, uint32_t * B) {
   uint8_t ord2[32] = {  5,14,26,18,11,28, 7,16, 0,23,20,22, 1,10, 4, 8,
                        30, 3,21, 9,17,24,29, 6,19,12,15,13, 2,25,31,27 };
   uint8_t ord3[32] = { 19, 9, 4,20,28,17, 8,22,29,14,25,12,24,30,16,26,
                        31,15, 7, 3, 1, 0,18,27,13, 6,21,10,23,11, 5, 2 };
   uint8_t ord4[32] = { 24, 4, 0,14, 2, 7,28,23,26, 6,30,20,18,25,19, 3,
                        22,11,31,21, 8,27,12, 9, 1,29, 5,15,17,10,16,13 };
   uint8_t ord5[32] = { 27, 3,21,26,17,11,20,29,19, 0,12, 7,13, 8,31,10, 
                         5, 9,14,30,18, 6,28,24, 2,23,16,22, 4, 1,25,15 };
   uint32_t K2[32] = { 0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c, 0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917,
                       0x9216d5d9, 0x8979fb1b, 0xd1310ba6, 0x98dfb5ac, 0x2ffd72db, 0xd01adfb7, 0xb8e1afed, 0x6a267e96,
                       0xba7c9045, 0xf12c7f99, 0x24a19947, 0xb3916cf7, 0x0801f2e2, 0x858efc16, 0x636920d8, 0x71574e69,
                       0xa458fea3, 0xf4933d7e, 0x0d95748f, 0x728eb658, 0x718bcd58, 0x82154aee, 0x7b54a41d, 0xc25a59b5 };
   uint32_t K3[32] = { 0x9c30d539, 0x2af26013, 0xc5d1b023, 0x286085f0, 0xca417918, 0xb8db38ef, 0x8e79dcb0, 0x603a180e,
   ...
   uint32_t K4[32] = { 0x7a325381, 0x28958677, 0x3b8f4898, 0x6b4bb9af, 0xc4bfe81b, 0x66282193, 0x61d809cc, 0xfb21a991,
   ...
   uint32_t K5[32] = { 0xba3bf050, 0x7efb2a98, 0xa1f1651d, 0x39af0176, 0x66ca593e, 0x82430e88, 0x8cee8619, 0x456f9fb4,
